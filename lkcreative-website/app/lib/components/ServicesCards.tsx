...
const ServicesCards: React.FC<ServicesCardsProps> = ({}) => {
  ...
  const cardArray = [<ServiceCard key="0" title="Social Media Account Management" description="Our expert team will handle all aspects of account management, from content creation and scheduling to community management."/>, <ServiceCard key="1" title="Social Media Marketing & Growth" description="Let us develop a tailored campaign to boost your brand visibility, drive engagement, and generate leads."/>, <ServiceCard key="2" title="Business Design & Branding" description="From logo design to brand guidelines, we will craft a captivating brand identity that reflects your story and speaks to your audience."/>, <ServiceCard key="3" title="Virtual Assisting" description="Allow us to lighten your workload! Our reliable team can handle administrative tasks, content research, and more so you can focus on the important things."/>, <ServiceCard key="4" title="Web Development" description="From Wix and Squarespace development to Fullstack custom projects, our team can build you a stunning new website that you can be proud of."/>]
